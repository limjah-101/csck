...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                <div class="card-header"><h2>Créer une page</h2></div>
                <div class="card-body">
                    <form action="{{ route('page.create') }}" method="POST">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control @error('url') border-danger @enderror" name="url" placeholder="https://example.com ...">
                            @error('url')
                                <div class="text-danger">{{ $message }}</div>
                            @enderror
                        </div>
                        ...
                        <div class="mt-4">
                            <button type="submit" name="page.create" class="btn btn-primary">Ajouter <i class="fas fa-check"></i> </button>
